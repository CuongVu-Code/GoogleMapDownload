...
namespace GoogleMapPlugin.Services
{
    public class GoogleWorldFileService
    {
            ...
            double ktt)
        {
            ...
            {
                throw new Exception(
                    "Kích thước ảnh Crop không khớp.\n\n" +
            ...
            double globalPixel1X =
                cropLeft + 0.5;

            double globalPixel1Y =
                cropTop + 0.5;


            double globalPixel2X =
                cropLeft +
                width -
                0.5;

            double globalPixel2Y =
                cropTop + 0.5;


            double globalPixel3X =
                cropLeft + 0.5;

            double globalPixel3Y =
                cropTop +
                height -
                0.5;
